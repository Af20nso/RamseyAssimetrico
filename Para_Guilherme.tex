...
\noindent\textbf{Nota.}
Este documento apresenta as definições, resultados da literatura e os
resultados originais relativos ao problema de Ramsey canônico assimétrico
em grafos aleatórios, preparado para discussão com o Coorientador.
...
\begin{proof}
  ...
  Agora usamos a definição de $L_x$. Como
  \[
    V(J)\subseteq N_\sigma^+(x),
  \]
  o vértice $x$ é adjacente, em $B$, a todos os vértices de $J$.

  Considere o cone sobre $J$ com ápice $x$, que denotaremos por
  \[
    C:=x+J.
  \]
  Formalmente,
  ...
  \[
    ...
    \right\}.
  \]
  Como $x$ é adjacente a todos os vértices de $J$, temos
  \[
    C\subseteq B.
  \]
